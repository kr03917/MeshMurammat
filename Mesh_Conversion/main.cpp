...
//int main()
{
	...
	//const char* filename = "bun_zipper_filled.obj";
	//const char* convert_to = "ply";
	...
	std::cout << "no of faces: " << mesh.number_of_faces() << std::endl;
	std::cout << "no of vertices: " << mesh.number_of_vertices() << std::endl;
